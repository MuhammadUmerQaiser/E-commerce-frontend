  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin/update/product/:productId" exact Component={AdminRoute}>
          <Route path="/admin/update/product/:productId" exact Component={UpdateProduct} />
        </Route>
        <Route path="/admin/products" exact Component={AdminRoute}>
